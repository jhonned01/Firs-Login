...
const Profiler = () => {
  ...
  return (
    <>
      <div className=" fixed left-0 md:left-1/3  md:top-0  right-0 ">
          ...
          <div className="  ">
            <div className="flex justify-end ">
              <section
                className={` ${
                  ShowProfiler ? "hidden" : ""
                } absolute right-9  w-48 rounded-md shadow-lg py-1 m-1 bg-white  ring-1 ring-black ring-opacity-5`}
              >
              ...
              <div className="relative ">
                <button className="" onClick={handleClickProfiler}>
                  <img
